    ...
    <div className="relative h-screen">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pointer-events-none">
        ...
        <p className="text-lg text-[#5a4a7a] max-w-md mb-10 drop-shadow">
          Upload files, share a link or QR code — anyone can access your cloud room.
        </p>
        <button className="pointer-events-auto bg-gradient-to-r from-[#9b72cf] to-[#c084fc] text-white font-bold text-base px-10 py-2 mt-3 rounded-full shadow-xl hover:-translate-y-1 hover:shadow-2xl transition-all duration-200 cursor-pointer">
          Get Started Free
        </button>
      </div>
    </div>
